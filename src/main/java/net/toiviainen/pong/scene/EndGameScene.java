...
//		PongApplication pongApplication = (PongApplication) application;
//		WelcomeScene welcomeScene = WelcomeScene.getWelcomeScene();
//
//		String result1 = welcomeScene.getPlayer1Name();
//		String result2 = welcomeScene.getPlayer2Name();
//
//		String winner;
//		if (p1Score > p2Score) {
//			winner = result1;
...
//			winner = "No winner";
//		}
//		WelcomeScene welcome = new WelcomeScene(application);

		String p1Name = read("p1Name.txt");
		String p2Name = read("p2Name.txt");
		winnerText = new Text((p1Score > p2Score ? p1Name:p2Name ) + " won the game!");
//		winnerText = new Text(winner + " player won the game!");
